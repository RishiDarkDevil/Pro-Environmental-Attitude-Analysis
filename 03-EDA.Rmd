...
-   **Clustering**: Hierarchial Agglomerative Clustering was used to cluster the items, domains and respondents to understand the similarity and dissimilarity of study variables and low and high scorers.
...
-   **Reliability Testing**: It was used to find out the reliability of the response data we habe collected.
